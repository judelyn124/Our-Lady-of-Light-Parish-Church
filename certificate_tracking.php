    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                <h5 class="ml-3 font-weight-bold text-primary">Track Certificate Requests</h5>
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-primary text-white">
                        <h6 class="m-0 font-weight-bold">Trackable Certificate Requests</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">No trackable requests found.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
